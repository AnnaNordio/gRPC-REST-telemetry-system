...
* **Windows:**
  ...
  * *Alternatively*: `make` is often included in Git BASH (MinGW). However, using **WSL** (Windows Subsystem for Linux) is highly recommended for this project to ensure full compatibility.
